...
from wawa import env
from wawa.managers.osu import Osu
...
class Misc(commands.Cog):
    ...
    async def osu(self, ctx, user:str):
        ...
        emoji_obj = discord.utils.get(interaction.guild.emojis, name='osu')
        ...
        osu_embed.set_footer(text=f'Requested by {interaction.user}', icon_url=interaction.user.avatar.url)
        ...
        await interaction.response.send_message(embed=osu_embed)
